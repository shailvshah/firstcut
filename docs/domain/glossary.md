...
> Every identifier in `src/firstcut/` and any future module must appear here first.
...
**Used in**: firstcut (core), templates
...
**Used in**: firstcut (core), all templates
...
**Used in**: firstcut (core), qa skill, tdd skill
